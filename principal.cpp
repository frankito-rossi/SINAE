...
//mediante la CI te dice la fecha, hora y lugar a vacunarse
                    ...
                    case 3:{
                        ...
                        if(ciPersona(pCRv) != -1){
                        	...
                        	printf("La reserva fue cancelada con exito.\n");
            ...
            case 2:
                ...
                printf("4. Reportes bajas vacunas.\n");
                printf("0. Salir.\n");
...
//Despliega la información de un SECOED., genera informe, manda mail.
                    	...
                    	char* filename;
                    	if(regR == 0)
                    		filename = "reportes/InfoNorte.txt";
                    	if(regR == 1)
                    		filename = "reportes/InfoSur.txt";
                    	if(regR == 2)
                    		filename = "reportes/InfoEste.txt";
                    	if(regR == 3)
                    		filename = "reportes/InfoOeste.txt";
                    	remove(filename);
...
//El sistema deberá emitir un subgrafo inducido por los puntos de vacunación a visitar, correspondiente a un SECOED.
                    ...
                    case 4:{
                    	FILE *archivo;
                    	char* reporte;
                    	reporte = "reportes/ReporteBajasVacunas.txt";
                    	remove(reporte);
                    	archivo = fopen(reporte, "a");
                    	fprintf(archivo, "asdhlawe %d", 1);

                    	generarReporteVacunas(S, *archivo);
                    	fclose(archivo);
